...
func init() {
	routerNoCheckRole = append(routerNoCheckRole, registerDemoRouter)
}
...
func registerDemoRouter(group *gin.RouterGroup) {
	api := apis.Demo{}
	r := group.Group("/studyDemo/demo")
	{
		// http://127.0.0.1:8000/api/v1/studyDemo/demo
		r.GET("", api.GetDemo)
	}
}
